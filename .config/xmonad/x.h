...
scratchpads = [ NS "pulsemixer" "alacritty --class pulsemixer -e pulsemixer" (className =? "pulsemixer") centerFloating
    ...
    centerFloating = customFloating $ W.RationalRect (1/4) (1/4) (1/2) (1/2)
    centerOther = customFloating $ W.RationalRect 0.3 0.25 0.35 0.6
...
myKeymap =
    ...
    ,("<XF86AudioPlay>",  spawn "playerctl -p kew,DeaDBeeF,Feishin play-pause") -- toggle play/pause mpd
    ,("<XF86AudioPrev>",  spawn "playerctl -p kew,DeaDBeeF,Feishin previous") -- skip to previous song mpd
    ,("<XF86AudioNext>",  spawn "playerctl -p kew,DeaDBeeF,Feishin next") -- skip to next song mpd
