...
bind = SUPER, Y, exec, obsidian
bind = SUPER, APOSTROPHE, exec, emacsclient -c
bind = SUPER, S, exec, ~/.local/bin/scrw select
bind=SUPER_SHIFT,S,exec, ~/.local/bin/scrw full
bind = SUPER_SHIFT,D,exec, ~/Documents/define
...
# toggle hyprshade
bind = SUPER|SHIFT, f, exec, hyprshade toggle fuji_acros
...
bindel = ,XF86AudioRaiseVolume, exec, sh -c 'wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+ && ~/.local/bin/getvol'
bindel = ,XF86AudioLowerVolume, exec, sh -c 'wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%- && ~/.local/bin/getvol'
bindel = ,XF86AudioMute, exec, sh -c 'wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle && ~/.local/bin/getvol'
...
workspace = special:pm, on-created-empty:[float; size 1000 800] $terminal -e wiremix, persistent:false
...
workspace = special:n, on-created-empty:[float; size 1100 450] $terminal -e kew, persistent:false
...
workspace = special:r, on-created-empty:[float; size 1800 850] obs, persistent:false
bind = super, r, togglespecialworkspace, r
workspace = special:u, on-created-empty:[float; size 1000 650] $terminal -e tomato, persistent:false
bind = super, u, togglespecialworkspace, u
#workspace = special:l, on-created-empty:[float; size 500 650] $terminal -e fsel, persistent:false
#bind = super, SPACE, togglespecialworkspace, l
workspace = special:b, on-created-empty:[float; size 500 650] $terminal -e bluetui, persistent:false
bind = super|SHIFT, b, togglespecialworkspace, b
#+end_src
...
windowrule = match:class mpv, float yes
windowrule {
  name = windowrule-3
  float = on
  pin = on
