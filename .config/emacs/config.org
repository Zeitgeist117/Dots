...
(defun my/set-fonts ()
  ...
  (cond
   ((find-font (font-spec :name "CozetteVector Nerd Font"))
    (set-face-attribute 'default nil :font "CozetteVector Nerd Font" :height 160 :weight 'medium)
    (set-face-attribute 'bold nil :weight 'extra-bold))
   ((find-font (font-spec :name "CozetteVector Nerd Font"))
    (set-face-attribute 'default nil :font "CozetteVector Nerd Font" :height 160)))
  (custom-set-faces
