...
static const char *fonts[]          = { "Departure Mono:size=14", "FontAwesome:size=14", "JoyPixels:pixelsize=14", "Sazanami Mincho:size=14" };
...
const char *spcmd5[] = {"st", "-n", "spmc", "-g", "110x20", "-e", "kew", NULL };
