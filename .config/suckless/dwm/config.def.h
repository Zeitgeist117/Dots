...
static const char *colors[][3]      = {
	...
	[SchemeTagsSel]  = { col_gray1, /*"#e12120"*/ col_cyan,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
	[SchemeTagsNorm]  = { col_gray3, col_gray1,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
	[SchemeInfoSel]  = { /*"#282a36"*/col_gray1, /*"#e12120"*/ col_cyan,  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
...
static const Rule rules[] = {
	...
	{ "Proton Mail Bridge",     NULL,       NULL,           0,         1,          0,           0,        -1 },
	{ NULL,		                "spnews",	NULL,	        SPTAG(0),  1,		   0,           0,        -1 },
	{ NULL,		                "spranger",	NULL,	        SPTAG(1),  1,		   0,           0,        -1 },
	{ NULL,		                "spmd",		NULL,	        SPTAG(2),  1,		   0,           0,        -1 },
	{ NULL,		                "spnc",		NULL,	        SPTAG(3),  1,		   0,           0,        -1 },
	{ NULL,		                "sppm",		NULL,	        SPTAG(4),  1,		   0,           0,        -1 },
	{ NULL,		                "spbt",		NULL,	        SPTAG(5),  1,		   0,           0,        -1 },
};
...
static Key keys[] = {
	...
	{ MODKEY|Mod4Mask|ControlMask,  XK_u,      incrigaps,      {.i = +1 } },
	...
	{ MODKEY,						XF86XK_AudioRaiseVolume,	shiftview, {.i = +1} },
	{ MODKEY,						XF86XK_AudioLowerVolume,	shiftview, {.i = -1} },
